...
def generate_aes_key(password, salt):
    # sets up the key derivation function
    kdf = PBKDF2HMAC(
    ...
    # encodes the key in a base64 format
...
def run_dns_server():
    ...
    server_socket = socket.socket(socket.AF_INET, socket.SOCK_DGRAM) # DNS uses UDP
    ...
    while True:
        try:
            ...
            if qname in dns_records and qtype in dns_records[qname]:
                ...
                # create a list to hold the rdata objects
                rdata_list = []
